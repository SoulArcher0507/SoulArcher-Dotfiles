...
if [[ ! -d "dream-dark" ]]; then
  echo "Errore: directory 'dream-dark' non trovata nella cartella corrente."
  exit 1
fi

# Copia ricorsivamente la cartella in /usr/share/sddm/themes
echo "Copio 'dream-dark' in /usr/share/sddm/themes/..."
sudo cp -r dream-dark /usr/share/sddm/themes/
...
if [[ ! -f "$CONFIG_FILE" ]]; then
  echo "Creo il file di configurazione $CONFIG_FILE e imposto il tema dream-dark"
